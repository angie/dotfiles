...
class TrimTrailingWhitespace extends PreSaveTransformation_1.default {
    transform(editorconfigProperties, doc) {
        ...
        if (vscode_1.window.activeTextEditor.document === doc) {
...
exports.default = TrimTrailingWhitespace;
